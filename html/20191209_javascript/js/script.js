...
//#1. 문자형 데이터 : "문자형 데이터", 문자 타입의 형태로 표현시 사용
 ...
 document.write(num_02+num_02, "<br>");

 //#3. 논리형 데이터 : true or false
 var $real_01 = false;
 var $big = 24<21;
 var $isTxt = Boolean("hi"); //Boolean("") : false , Boolean("값이 있음") : true
...
//데이터의 형태가 무엇인지를 확인!!!
 ...
 console.log(typeof $real_01); //논자형 데이터
 ...
 /*대입연산자 : 지속적으로 추가된 값(1보다 큰수)을 적용하여 증가 또는 감소*/
 var $no_01 = 13;
 var $no_02 = 6;
 ...
 /*증감 연산자 : 1씩 증가시키거나 1씩 감소시킬 떄 사용하는 연산자*/
 /*
	받아오는 변수가 없는 경우, 단항으로 연산($no++, ++$no)으로 연산
 */
 ...
 /*or 연산자는 전체 true 라면 당연히 true*/

 /*논리연산자 ( && 연산자 => and 연산자 : 내부의 값이 하나라도 false면 전체의 값은 false)*/
var $a = 10;
var $b = 12;
var $c = 24;
var $d = 21;
 ...
 document.write($result, "<br>");
 /*and 연산자는 전체 true 가 되어야 true으로 반환 */

 /*논리 연산자 (! 연산자 => not 연산자 : 기존의 값이 true라면 반대로 false를 반환*/
 $result = !($a>$b);
 document.write($result, "<br>");

 /*삼항조건 연산자 조건문? 실행문1 : 실행문2   => 조건식이 true 이면 실행문 1번을 실행, 조건식이 false라면 실행문 2번을 실행*/
 var $hour = 14;
 ...
 if($userName){
	document.write($userName+"님의 방문을 환영합니다.");
 }
