$(document).ready(function(){
	...
	["img_03.jpg", "title_03", "context_03", "https://www.google.com"],
	...
	$(".grid-item a").click(function(){
		...
		$(".popup_img").css("background-image", "url(img/"+$item_arr[$index][0]+")");
	...
	$(".grid").masonry({
		...
		isAnimated : true //애니메이션 기능을 활성화(반응형까지 진행될 경우, 움직이는 동적 효과를 부여할 수 있음)
	});
});