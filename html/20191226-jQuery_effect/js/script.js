$(document).ready(function(){
	...
	// ease : 최초 시간대비 속도가 느리게 적용하다가 도달하는 시점에서 시간대비 속도를 늦추는 방법
	...
	$(".menu>li").hover(function(){ //마우스가 영역 내부로 진입했을때
    ...
    var depth = 2; //레이어 상의 z-index 값을 올려서 해당하는 순서를 배치 하기 위한 초기값 선언
    (function ani(){
