$(document).ready(function(){
	...
	var $pd_arr=[
		...
		["img2.jpg", "거실 인테리어2", "합리적인 실용주의 인테리어2", "40000", "20191107", "8"],  //1
		["img3.jpg", "침실 인테리어1", "합리적인 실용주의 인테리어3", "50000", "20191004", "32"], //2
		["img4.jpg", "침실 인테리어2", "합리적인 실용주의 인테리어4", "90000", "20191208", "42"], //3
		["img5.jpg", "주방 인테리어", "합리적인 실용주의 인테리어5", "70000", "20191230", "24"],  //4
		["img6.jpg", "침실 인테리어3", "합리적인 실용주의 인테리어6", "80000", "20190930", "87"], //5
		["img7.jpg", "서재 인테리어", "합리적인 실용주의 인테리어7", "60000", "20190112", "54"],  //6
		["img8.jpg", "욕실 인테리어", "합리적인 실용주의 인테리어8", "100000", "20190308", "65"], //7
		["img9.jpg", "거실 인테리어3", "합리적인 실용주의 인테리어9", "120000", "20190715", "9"], //8
		["img1.jpg", "거실 인테리어4", "합리적인 실용주의 인테리어1", "30000", "20190807", "23"], //9
		["img2.jpg", "거실 인테리어2", "합리적인 실용주의 인테리어2", "40000", "20191107", "8"],  //10
		["img3.jpg", "침실 인테리어1", "합리적인 실용주의 인테리어3", "50000", "20191004", "32"], //11
		["img4.jpg", "침실 인테리어2", "합리적인 실용주의 인테리어4", "90000", "20191208", "42"], //12
		["img5.jpg", "주방 인테리어", "합리적인 실용주의 인테리어5", "70000", "20191230", "24"],  //13
		["img6.jpg", "침실 인테리어3", "합리적인 실용주의 인테리어6", "80000", "20190930", "87"], //14
		["img7.jpg", "서재 인테리어", "합리적인 실용주의 인테리어7", "60000", "20190112", "54"],  //15
		["img8.jpg", "욕실 인테리어", "합리적인 실용주의 인테리어8", "100000", "20190308", "65"], //16
		["img9.jpg", "거실 인테리어3", "합리적인 실용주의 인테리어9", "120000", "20190715", "9"], //17
	...
	//배열의 데이터 갯수가 각 페이지별로 분배되는 과정에서 나머지 값이 존재 한다면
	}else{
		for(k=0; k<=($pd_arr.length / $ea_item); k++){
			$(".pager ul").append("<li>"+(k+1)+"</li>");
		}
...
//#2. .pd_box에 순차적으로 접근한다. -> 배열의 데이터를 각 항목별로 넣어준다.	
	...
	//만약 pager의 통제에 의한 페이지 보여주기에서 각 페이지 별로 8씩 보여주어야 한다면
	/*
	...
	n번(인덱스 n-1) 페이지에 인덱스 (8*(인덱스n-1)) ~ (8*((인덱스n-1)+1)-1)까지 보여주어야 한다.
	*/
	...
	$(".pager li").click(function(){ //각 번호를 클릭했을 떄
